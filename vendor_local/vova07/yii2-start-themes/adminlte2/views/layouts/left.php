        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => Module::t('menu','PRISONERS_SECURITY_LIST'),'icon' => 'hourglass-1','url'=>['/prisons/prisoner-security/index'],
                 ...
                 /*   ['label' => Module::t('menu','STATISTICS_MENU'),'icon' => 'pie-chart','url'=>['#'],
                        'items' => [
                            ['label' => Module::t('menu','PROGRAMS_MENU'),'icon' => 'circle-o','url'=>['']],
                            ['label' => Module::t('menu','JOBS_MENU'),'icon' => 'circle-o','url'=>['']],
                            ['label' => Module::t('menu','WORKSHOPS_MENU'),'icon' => 'circle-o','url'=>['']],
                        ]
                    ],*/
                    ['label' =>  Module::t('menu', 'ACTS_AND_DOCUMENTS_MENU'),'icon' => 'files-o','url' => '#' ,
                        'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_DOCUMENTS_LIST),
                        'items' => [
                            ['label' => Module::t('menu','DOCUMENTS_LIST'),'icon' => 'circle-o','url'=>['/documents/default/index']],
                        //    ['label' => Module::t('menu','BLANKS_LIST'),'icon' => 'circle-o','url'=>['/documents/blanks/index']],
                          //  ['label' => Module::t('menu','PRISONER_BLANKS_LIST'),'icon' => 'circle-o','url'=>['/documents/blank-prisoners/index']],
                        ]
                    ],
                    [
                        ...
                        'items' => [
                            ['label' => Module::t('menu','EVENTS_LIST'),'icon' => 'circle-o','url'=>['/events/default/index']],

                        ]
                    ],
                    ['label' =>  Module::t('menu', 'TASKS_MENU'),'icon' => 'calendar-check-o','url' => '#' ,
                        'items' => [
                            ['label' => Module::t('menu','COMMITTIES_LIST'),'icon' => 'circle-o','url'=>['/tasks/committee/index'],
                    ...
                    ['label' =>  Module::t('menu', 'HUMANITARIAN_MENU'),'icon' => 'cube','url' => '#' ,
                        ...
                        'items' => [
                            ...
                            ['label' => Module::t('menu','HUMANITARIAN_LIST'),'icon' => 'circle-o','url'=>['/humanitarians/issues/index']],
                            ['label' => Module::t('menu','HUMANITARIAN_ITEMS_LIST'),'icon' => 'circle-o','url'=>['/humanitarians/items/index']],
                        ]
                    ],
                    ['label' =>  Module::t('menu', 'JOBS_MENU'),'icon' => 'cube','url' => '#' ,
                        ...
                        'items' => [
                            ['label' => Module::t('menu','AVAILABLE_JOBS_LIST'),'icon' => 'circle-o','url'=>['/jobs/job-list/index']],
                            ['label' => Module::t('menu','JOBS_LIST'),'icon' => 'circle-o','url'=>['/jobs/default/index']],
                            ['label' => Module::t('menu','NOT_PAID_JOBS_LIST'),'icon' => 'circle-o','url'=>['/jobs/not-paid-jobs/index']],
                            ['label' => Module::t('menu','NOT_PAID_TYPES_LIST'),'icon' => 'circle-o','url'=>['/jobs/not-paid-types/index']],
                            ['label' => Module::t('menu','PAID_TYPES_LIST'),'icon' => 'circle-o','url'=>['/jobs/paid-types/index']],
                    ...
                    ['label' =>  Module::t('menu', 'FINANCE_MENU'),'icon' => 'credit-card','url' => '#' ,
                        ...
                        'items' => [
                            ['label' => Module::t('menu','BALANCE_LIST'),'icon' => 'circle-o','url'=>['/finances/default/index']],
                        ]
                    ],
                    ['label' =>  Module::t('menu', 'ELECTRICITY_MENU'),'icon' => 'tv','url' => '#' ,
                        'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_FINANCES_ACCESS),
                        'items' => [
                            ['label' => Module::t('menu','DEVICES_ACCOUNTING_LIST'),'icon' => 'circle-o','url'=>['/electricity/default/index']],
                            ['label' => Module::t('menu','DEVICES_LIST'),'icon' => 'circle-o','url'=>['/electricity/devices/index']],
                            [
                                    'label' => Module::t('menu','BALANCE_IMPORT'),'icon' => 'circle-o','url'=>['/electricity/balance-import/index'],
                    ...
                    ['label' =>  Module::t('menu', 'PROGRAMS_MENU'),'icon' => 'calendar-check-o','url' => '#',
                        'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_PRISONER_PLAN_VIEW),
                        'items' => [
                            ['label' => Module::t('menu','PROGRAMS_DICTS_LIST'),'icon' => 'circle-o','url'=>['/plans/program-dicts'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_PROGRAM_PLANING_LIST)],
                            ['label' => Module::t('menu','PROGRAMS_LIST'),'icon' => 'circle-o','url'=>['/plans/programs'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_PRISONER_PLAN_VIEW)],
                            ['label' => Module::t('menu','PROGRAM_PLANS_LIST'),'icon' => 'circle-o','url'=>['/plans/program-plans'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_PRISONER_PLAN_VIEW)],
                    ...
                    ['label' =>  Module::t('menu', 'AUTHORIZE_MENU'),'icon' => 'barcode','url' => '#',
                        'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC),
                        'items' => [
                            ['label' => Module::t('menu','RBAC_PERMISSION_MENU'),'icon' => 'circle-o','url'=>['/rbac/permissions'],
                            'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)
                            ],
                            [
                                    'label' => Module::t('menu','RBAC_ROLES_MENU'),'icon' => 'circle-o','url'=>['/rbac/roles'],
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)
                            ],
                            ['label' => Module::t('menu','RBAC_RULES_MENU'),'icon' => 'circle-o','url'=>['/rbac/rules'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)]
                        ]
                    ],
                    ['label' =>  Module::t('menu', 'USERS_MENU'),'icon' => 'users','url' => '#',
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC),
                        'items' => [
                            ['label' => Module::t('menu','USERS_LIST'),'icon' => 'circle-o','url'=>['/users/default'],
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
                            ['label' => Module::t('menu','OFFICERS_LIST'),'icon' => 'circle-o','url'=>['/users/officers'],
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
                            ['label' => Module::t('menu','PEOPLE_LIST'),'icon' => 'circle-o','url'=>['/users/people'],
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
                        ]
                    ],
                    ['label' =>  Module::t('menu', 'PRISONS_MENU'),'icon' => 'bank','url' => '#',
                                    'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC),
                        'items' => [
                            ['label' => Module::t('menu','COMPANIES_LIST'),'icon' => 'circle-o','url'=>['/prisons/companies'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
                            ['label' => Module::t('menu','DEPARTMENTS_LIST'),'icon' => 'circle-o','url'=>['/prisons/departments'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
                            ['label' => Module::t('menu','PRISONS_LIST'),'icon' => 'circle-o','url'=>['/prisons/default'],
                                'visible' => \vova07\rbac\helpers\Rbac::checkAccess(\vova07\rbac\Module::PERMISSION_ADMINISTRATE_RBAC)],
