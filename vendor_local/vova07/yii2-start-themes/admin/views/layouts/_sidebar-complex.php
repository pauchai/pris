        ...
        'items' => [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('vova07/themes/admin', 'PersonActivities'),
                        'url' => ['/prisons/person-activities/index'],
                        'visible' => true,
                    ],
            ...
            [
                'label' => Yii::t('vova07/themes/admin', 'Contries'),
                'url' => ['/prisons/countries/index'],
                'icon' => 'fa-group',
                'visible' => true,
            ],
            [
