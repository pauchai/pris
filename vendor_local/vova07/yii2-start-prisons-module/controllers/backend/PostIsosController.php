...
use vova07\prisons\models\backend\PostIsoSearch;
...
class PostIsosController extends BackendController
{
    ...
    {
        if (is_null($model = PostIso::findOne($id)))
        {
