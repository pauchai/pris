...
use vova07\salary\models\backend\SalaryClassSearch;
...
class SalaryClassesController extends BackendController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new SalaryClassSearch();
    ...
    {
        if (is_null($model = SalaryClass::findOne($id)))
        {
