...
class IssueController extends BackendController
{
    ...
    public function actionUpdate($year, $month_no)
    {
    ...
    public function actionChangeStatus($year, $month_no)
    {
        if (is_null($model = SalaryIssue::findOne(compact('year', 'month_no'))))
        {
            throw new NotFoundHttpException(Module::t("ISSUE_NOT_FOUND"));
