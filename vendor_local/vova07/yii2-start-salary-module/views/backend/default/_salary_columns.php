...
$columns =
        ...
        'groupHeader' => function ($model){
            ...
            return [
                ...
                'content' => [             // content to show in each summary cell
                    ...
                    2 => ArrayHelper::getValue($model,'officer.person.fio'),
                    4 => $modalContent,
                    19 => GridView::F_SUM,
                ...
                'contentFormats' => [      // content reformatting for each summary cell
                    ...
                    19 => ['format'=>'number', 'decimals'=>2, 'decPoint'=>'.', 'thousandSep'=>',']
                ],
    ...
    [
        ...
        'format' => 'html',
        'content' =>  function($model,$index,$key){
            $content = ArrayHelper::getValue($model,'postDict.title') . ' ' . (ArrayHelper::getValue($model, "full_time")?'полная':'полставки');
