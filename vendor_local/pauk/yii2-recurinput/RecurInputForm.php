...
/**
 * RecurInputForm is the model behind the recur input form.
 */
class RecurInputForm extends Model
{
...
//	public $byeaster;
    ...
    public static function getFrequenciesList()
    {
        return [
            self::FREQUENCY_DAILY => Yii::t('pauk/recurinput','FREQUENCY_DAILY'),
            self::FREQUENCY_WEEKLY => Yii::t('pauk/recurinput','FREQUENCY_WEEKLY'),
            self::FREQUENCY_MONTHLY => Yii::t('pauk/recurinput','FREQUENCY_MONTHLY'),
            self::FREQUENCY_YEARLY => Yii::t('pauk/recurinput','FREQUENCY_YEARLY'),
        ];
    }
}
